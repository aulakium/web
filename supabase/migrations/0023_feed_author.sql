-- ════════════════════════════════════════════════════════════════════════
-- Colequium — El autor siempre ve sus propios avisos en el Muro.
-- Antes el feed mostraba solo lo que matcheaba la audiencia del usuario, así que
-- si Dirección publicaba "a padres", no veía su propio aviso. Ahora incluye
-- también los posts cuyo autor es uno mismo.
-- ════════════════════════════════════════════════════════════════════════
